...
import { Button, ButtonProps, LinkButton } from "@/app/components/button/button"
...
export const Dropdown = ({ menu, ...props }: DropdownProps) => {
    ...
    return (
        <Root>
            ...
            <Portal>
                <Content
                    className="z-100 -mx-[2px] flex flex-col border-2 border-gray-950 bg-gray-900 p-1 shadow-lg shadow-gray-950"
                    collisionPadding={24}
                    style={accentStyle}
                >
                    {menu.map((item, i) => {
