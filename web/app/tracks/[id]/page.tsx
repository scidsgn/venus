...
import { TrackLyrics } from "@/app/tracks/[id]/track-lyrics"
import { TrackPlaybackButtons } from "@/app/tracks/[id]/track-playback-buttons"
import { TrackWaveformContainer } from "@/app/tracks/[id]/waveform/track-waveform-container"
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        {track.disc_track && (
                            <p className="font-medium">
                                ...
                                <Link
                                    className="text-accent-500"
                                    href={`/albums/${track.disc_track.disc.album.id}`}
                                >
