...
export const LoginForm = () => {
    ...
    const login = useAction(loginAction, userActionErrorMapper)

    const [redirect] = useQueryState("redirect")

    const onSubmit = async (data: z.infer<typeof loginSchema>) => {
        await login.run(data.userName, data.password, redirect)
    }
    ...
    return (
        ...
        >
            ...
            <Button
                ...
                variant="accent"
                size="lg"
                ongoing={formState.isSubmitting || login.ongoing}
            >
                Log in
            </Button>
        </form>
